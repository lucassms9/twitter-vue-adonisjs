<template>
    <div>
        ...
        <div class="ui four item attached menu">
            <router-link class="item" to="/">
                <i class="home icon"></i>
            </router-link>
            <router-link class="item" :to="`/${user.username}`">Perfil</router-link>
            <router-link class="item" to="/settings/profile">Meus Dados</router-link>
