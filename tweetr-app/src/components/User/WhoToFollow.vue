<template>
    <div class="ui segment">
        <h2 class="ui medium dividing header">Seguir</h2>
        ...
        <div class="ui divided link items">
            <div class="item" v-for="user in usersToFollow" :key="user.id">
                ...
                <div class="content">
                    ...
                    <div class="meta">
                        <button class="ui compact button mini primary" @click="followUser(user.id)">Seguir</button>
                    </div>
                </div>
            </div>
        </div>
